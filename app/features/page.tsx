          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card>
              <CardContent className="pt-6">
                ...
                <p className="text-muted-foreground">
                  Specializes in chicken dishes inspired by Cochin, India, with
                  a fusion of local Ethiopian flavors, creating a unique
                  culinary experience.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="pt-6">
                ...
                <p className="text-muted-foreground">
                  Beautifully designed interior blending Indian and Ethiopian
                  cultures for a warm and inviting atmosphere.
                </p>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="pt-6">
                ...
                <p className="text-muted-foreground">
                  ...
                  Ethiopian cuisine, celebrating the historical connections
            ...
            <Card>
              <CardContent className="pt-6">
                ...
                <p className="text-muted-foreground">
                  We source the freshest local ingredients and authentic Indian
                  spices to ensure every dish meets our high standards.
                </p>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="py-16 bg-muted/30">
        <div className="container">
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            ...
            <div>
              <h2 className="text-3xl font-bold mb-6">Unique Fusion Cuisine</h2>
              <p className="text-muted-foreground mb-4">
                Our chefs have spent years perfecting the art of blending Indian
                and Ethiopian flavors. The result is a menu that offers the best
                of both worlds - the rich, aromatic spices of Cochin combined
                with the bold, distinctive flavors of Ethiopian cuisine.
              </p>
              <p className="text-muted-foreground">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
            <div className="order-2 md:order-1">
              <h2 className="text-3xl font-bold mb-6">Cultural Ambiance</h2>
              <p className="text-muted-foreground mb-4">
                Step into CHOCHINCHICKEN and you'll immediately notice the
                thoughtful design that pays homage to both Indian and Ethiopian
                cultures. From the artwork on the walls to the music playing
                softly in the background, every element has been chosen to
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <h2 className="text-3xl font-bold mb-6">Premium Ingredients</h2>
              <p className="text-muted-foreground mb-4">
                We believe that great food starts with great ingredients. That's
                why we source the freshest local produce and meats, complemented
                by authentic spices imported directly from India.
              </p>
              <p className="text-muted-foreground">
